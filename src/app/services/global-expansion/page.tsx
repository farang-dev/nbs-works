  ...
  const processSteps = [
    {
      ...
      description: t('globalExpansion.process.deconstruct.description'),
    },
    {
      name: t('digitalExperience.process.build.title'),
      description: t('globalExpansion.process.build.description'),
    },
    {
      name: t('digitalExperience.process.grow.title'),
      description: t('globalExpansion.process.grow.description'),
    },
  ]

  const deliverables = [
    t('globalExpansion.deliverables.1'),
    t('globalExpansion.deliverables.2'),
    t('globalExpansion.deliverables.3'),
    t('globalExpansion.deliverables.4'),
    t('globalExpansion.deliverables.5'),
    t('globalExpansion.deliverables.6'),
    t('globalExpansion.deliverables.7'),
    t('globalExpansion.deliverables.8'),
  ]

  const keywords = [
    t('globalExpansion.keywords.1'),
    t('globalExpansion.keywords.2'),
    t('globalExpansion.keywords.3'),
    t('globalExpansion.keywords.4'),
  ]
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <h1 className="text-4xl font-bold tracking-tighter text-primary-text sm:text-5xl">
                {t('services.globalExpansion.name')}
              </h1>
              <p className="mt-6 text-lg text-secondary-text">
                {t('globalExpansion.hero.subtitle')}
              </p>
            </MotionDiv>
          </div>
        </Container>
